...
if __name__ == "__main__":
    ...
    batch_dataset = Planetoid(
        "datasets/citeseer/", "Citeseer", transform=NormalizeFeatures()
    )
    ...
    # save net
    torch.save(model, "link_prediction/checkpoints/vgae_citeseer.pt")
...
# precision:
# 200 epoch, 16 latent size, lr=0.01, correct KL regularization - .770~.776 - note: it creeps up to .144 at 100-140 epochs.
# 110 epoch, 16 latent size, lr=0.01, correct KL regularization - .794~.822 (4) - values collapsed a little less.
